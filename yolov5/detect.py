    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if webcam:  # batch_size >= 1
                ...
                # ---------- HELMET ZONE (ONCE PER FRAME) ----------
                frame_height = im0.shape[0]      # height of the frame
                helmet_y = frame_height * 0.6    # virtual helmet position
                prev_y = None
                s += f"{i}: "
            else:
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    #if object_y < helmet_y:
                        #print("Object above helmet")
                    if prev_y is not None:
                        if object_y < helmet_y and (object_y - prev_y) > 25:
                            print("DANGER: Falling object above helmet")
